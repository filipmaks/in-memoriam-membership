...
<div class="container user-membership-postcreate">
                                                ...
                                                case "editor_with_title_subtitle":
                                                    ...
                                                    <div class="element-container">
                                                        ...
                                                        <div class="image-field">
                                                            ...
                                                            <input type="hidden" data-fieldname="element_type" name="element_type[<?= $i ?>][<?= $c ?>]"
 ...
 <?php
                                                    ...
                                                    <div class="element-container">
                                                        ...
                                                        <div class="image-field">
                                                            ...
                                                            <div id="full-editor-container--element-2-2-0">
                                                                ...
                                                                <input type="hidden" data-fieldname="element_type" name="element_type[<?= $i ?>][<?= $c ?>]" value="full_editor"> 
            ...
            <div class="custom-field-container">
                ...
                <div class="add-fields" data-rownumber="0">
    ...
    $(document).on('click', '.remove-to-add-element', function () {
        ...
        if (confirm('Da li si siguran da zelis da obrises ovaj blok?')) {
            ...
            if ($(this).parents('.member-post-row').find('.custom-column-class').length == 1) {
                ...
                $(this).parents('.row.member-post-row').trigger('click');

            } else {

                $(this).parents('.custom-column-class').remove();
            }
...
<option value='bottom-right'>Bottom Right</option></select></div>";
            ...
            case "video_with_title_subtitle":
                ...
                html += "<div class='image-field'><div class='member-ship-loader'></div><label>Video</label>\n\
        <input type='hidden' data-fieldname='element_type' name='element_type[" + row_number + "][" + thisColumn + "]' value='video_with_title_subtitle'> <input data-fieldname='member_ship_image_id' name='member_ship_image_id[" + row_number + "][" + thisColumn + "]' type='hidden'\n\
 class='member-ship-image-id'><div class='membership-image-container'>\n\
...
<option value='bottom-right'>Bottom Right</option></select></div>";
            ...
            case "editor_with_title_subtitle":
                ...
                html += "<div class='image-field'><label></label><div class='view-description'></div>\n\
      <input type='hidden' data-fieldname='element_type' name='element_type[" + row_number + "][" + thisColumn + "]' value='editor_with_title_subtitle'>   <textarea data-fieldname='editor' name='editor[" + row_number + "][" + thisColumn + "]' style='display:none' \n\
...
<option value='bottom-right'>Bottom Right</option></select></div>";
            ...
            case "full_editor":
                ...
                html += "<div class='image-field'><label></label><div class='view-description'>\n\
         </div><div id='full-editor-container--" + thisRowID + "'>\n\
<input type='hidden' data-fieldname='element_type'  name='element_type[" + row_number + "][" + thisColumn + "]' value='full_editor'> <textarea style='display:none'  name='editor[" + row_number + "][" + thisColumn + "]' \n\
...
e.preventDefault();
        ...
        var html = "<div class='row member-post-row " + column_class_row + "'>";
        ...
        var sortable = new Sortable(sortableList, {
            onEnd: function (evt) {
                ...
                var updatedOrder = sortable.toArray();
    ...
    $(document).ready(function () {
        ...
        $(document).on('click', '.fields-member-post-container .remove', function () {
            ...
            if (confirm('Are you sure you want to delete this record?')) {
                ...
                if ($('.row.member-post-row').length > 0) {
                    ...
                    $('.row.member-post-row').each(function (index) {
                        ...
                        $(this).find('.add-element').each(function (childindex) {
                            ...
                            if ($(this).find('input').length > 0) {
                                ...
                                $(this).find('input').each(function (indexelement) {
                                    ...
                                    fld_name = fld_name + '[' + index + '][' + indexelement + ']';
                        ...
                        $(this).find('input[name="rows_number[]"]').val(row_number)
                    })
